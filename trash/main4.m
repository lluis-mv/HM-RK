...
for nu = NU
    for StabMethod = [1:5]
        ...
        figure(4)
        subplot(3,2,StabMethod)
        [WP, U, L2, LInf, L2DISPL, LInfDISPL] = ConstructAndSolveProblem(20, 0.0001, 1, StabMethod, nu);
...
function [NodalWaterPressure, NodalDisplacement, L2, LInf, L2DISPL, LInfDISPL] = ConstructAndSolveProblem( nNodes, tFinal, nTimeSteps, StabMethod, nu)
