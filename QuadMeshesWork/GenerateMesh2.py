...
# Puntos:
p1 = geom.addPoint(0, -5, 0)  # Punto central del círculo
p2 = geom.addPoint(5, -5, 0)
p3 = geom.addPoint(5, 0.0, 0)
p4 = geom.addPoint(1, 0.0, 0)
p5 = geom.addPoint(0, 0.0, 0)
...
n = 6  # Líneas perpendiculares al círculo

#for tag in [l1, l2, l3, l4, l5]:
#    gmsh.model.geo.mesh.setTransfiniteCurve(tag, n+1)
#gmsh.model.geo.mesh.setTransfiniteCurve(l1, 5+7+1)
#gmsh.model.geo.mesh.setTransfiniteCurve(l2, 9)
#gmsh.model.geo.mesh.setTransfiniteCurve(l3, 5+1)
#gmsh.model.geo.mesh.setTransfiniteCurve(l4, 7+1)
#gmsh.model.geo.mesh.setTransfiniteCurve(l5, 9)
