...
if ( LinearElastic)
    ...
    [U1, GPInfo1, rrr1,  information1] = ComputeNLProblemVisco(Nodes1, Elements1, CP, dt, nSteps, 'T3T3', RK, 1, false);
end
figure(1)
...
if ( LinearElastic)
    ...
    [U2, GPInfo, rrr,  information2] = ComputeNLProblemVisco(Nodes, Elements, CP, dt, nSteps, 'T6T3', RK, 1, false);
end
