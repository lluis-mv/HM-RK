...
for Elem = [1,2,3]
    ...
    for eSize = ESIZE
        ...
        axis equal
        axis off
        print('ExampleFour-Plastic-FemMesh', '-dpdf')
        ...
        for j = 1:length(NSteps)
            for RK = RKMethods
                ...
                figure(2105)
                pause(1)
                print(['ExampleFour-Plastic-Residual-', num2str(Elem)], '-dpdf')
                figure(2106)
                pause(1)
                print(['ExampleFour-Plastic-Bearing-', num2str(Elem)], '-dpdf')
                figure(2107)
                pause(1)
                print(['ExampleFour-Plastic-Error-', num2str(Elem)], '-dpdf')
                figure(2108)
                pause(1)
                print(['ExampleFour-Plastic-TimeError-', num2str(Elem)], '-dpdf')
            end
